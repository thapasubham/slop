import{e as ql,d as va,b as Dn,a as zt,f as Vt,s as Sr}from"../chunks/B-31Gf2r.js";import{k as Yl,E as $o,a as Kl,a$ as $l,aL as Zl,e as Jl,u as jl,b0 as Ql,b1 as ec,as as tc,b2 as Ti,b3 as Zo,i as Xa,ad as xi,ae as Ur,af as Er,ag as Mi,ah as bt,ai as _t,aC as Cr,aj as At,x as Tt,z as _n,a6 as Bi,an as Wi,b4 as nc}from"../chunks/CuIsswtt.js";import{B as ic,p as rc,i as Ui}from"../chunks/DPP91Lbm.js";import{t as sc,e as qa,i as Ya,s as ac,u as Jo,a as oc}from"../chunks/CqWs35o_.js";import{b as Ni}from"../chunks/B3hEFGGQ.js";function lc(i,e,...t){var n=new ic(i);Yl(()=>{const r=e()??null;n.ensure(r,r&&(s=>r(s,...t)))},$o)}const cc=()=>performance.now(),mn={tick:i=>requestAnimationFrame(i),now:()=>cc(),tasks:new Set};function jo(){const i=mn.now();mn.tasks.forEach(e=>{e.c(i)||(mn.tasks.delete(e),e.f())}),mn.tasks.size!==0&&mn.tick(jo)}function uc(i){let e;return mn.tasks.size===0&&mn.tick(jo),{promise:new Promise(t=>{mn.tasks.add(e={c:i,f:t})}),abort(){mn.tasks.delete(e)}}}function Pr(i,e){Zo(()=>{i.dispatchEvent(new CustomEvent(e))})}function hc(i){if(i==="float")return"cssFloat";if(i==="offset")return"cssOffset";if(i.startsWith("--"))return i;const e=i.split("-");return e.length===1?e[0]:e[0]+e.slice(1).map(t=>t[0].toUpperCase()+t.slice(1)).join("")}function Ka(i){const e={},t=i.split(";");for(const n of t){const[r,s]=n.split(":");if(!r||s===void 0)break;const a=hc(r.trim());e[a]=s.trim()}return e}const fc=i=>i;function dc(i,e,t,n){var r=(i&Ql)!==0,s="both",a,o=e.inert,c=e.style.overflow,l,f;function m(){return Zo(()=>a??=t()(e,n?.()??{},{direction:s}))}var u={is_global:r,in(){e.inert=o,l=bs(e,m(),f,1,()=>{Pr(e,"introend"),l?.abort(),l=a=void 0,e.style.overflow=c})},out(p){e.inert=!0,f=bs(e,m(),l,0,()=>{Pr(e,"outroend"),p?.()})},stop:()=>{l?.abort(),f?.abort()}},d=Kl;if((d.nodes.t??=[]).push(u),ql){var g=r;if(!g){for(var M=d.parent;M&&(M.f&$o)!==0;)for(;(M=M.parent)&&(M.f&$l)===0;);g=!M||(M.f&Zl)!==0}g&&Jl(()=>{jl(()=>u.in())})}}function bs(i,e,t,n,r){var s=n===1;if(ec(e)){var a,o=!1;return tc(()=>{if(!o){var p=e({direction:s?"in":"out"});a=bs(i,p,t,n,r)}}),{abort:()=>{o=!0,a?.abort()},deactivate:()=>a.deactivate(),reset:()=>a.reset(),t:()=>a.t()}}if(t?.deactivate(),!e?.duration&&!e?.delay)return Pr(i,s?"introstart":"outrostart"),r(),{abort:Ti,deactivate:Ti,reset:Ti,t:()=>n};const{delay:c=0,css:l,tick:f,easing:m=fc}=e;var u=[];if(s&&t===void 0&&(f&&f(0,1),l)){var d=Ka(l(0,1));u.push(d,d)}var g=()=>1-n,M=i.animate(u,{duration:c,fill:"forwards"});return M.onfinish=()=>{M.cancel(),Pr(i,s?"introstart":"outrostart");var p=t?.t()??1-n;t?.abort();var h=n-p,x=e.duration*Math.abs(h),y=[];if(x>0){var E=!1;if(l)for(var w=Math.ceil(x/16.666666666666668),A=0;A<=w;A+=1){var C=p+h*m(A/w),v=Ka(l(C,1-C));y.push(v),E||=v.overflow==="hidden"}E&&(i.style.overflow="hidden"),g=()=>{var T=M.currentTime;return p+h*m(T/x)},f&&uc(()=>{if(M.playState!=="running")return!1;var T=g();return f(T,1-T),!0})}M=i.animate(y,{duration:x,fill:"forwards"}),M.onfinish=()=>{g=()=>n,f?.(n,1-n),r()}},{abort:()=>{M&&(M.cancel(),M.effect=null,M.onfinish=Ti)},deactivate:()=>{r=Ti},reset:()=>{n===0&&f?.(1,0)},t:()=>g()}}function pc(i,e,t,n){var r=i.__style;if(Xa||r!==e){var s=sc(e);(!Xa||s!==i.getAttribute("style"))&&(s==null?i.removeAttribute("style"):i.style.cssText=s),i.__style=e}return n}const mc=!0,gc="always",vg=Object.freeze(Object.defineProperty({__proto__:null,prerender:mc,trailingSlash:gc},Symbol.toStringTag,{value:"Module"})),_c=i=>i;function vc(i,{delay:e=0,duration:t=400,easing:n=_c}={}){const r=+getComputedStyle(i).opacity;return{delay:e,duration:t,easing:n,css:s=>`opacity: ${s*r}`}}var xc=Vt("<button> </button>"),Mc=Vt('<button type="button" class="fixed inset-0 z-50 bg-void/90 backdrop-blur-xl md:hidden cursor-default" aria-label="Close menu"><div class="flex h-full flex-col items-end justify-center p-12 gap-8"></div></button>'),Sc=Vt(`<button class="
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function jd(i,e,t){const n=new Float32Array(qn),r=new D(0,1,0);return new on({name:"SphericalGaussianBlur",defines:{n:qn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Br(),fragmentShader:`
	...
	`}class Dl extends nn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new yl(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Ki(5,5,5),s=new on({name:"CubemapFromEquirect",uniforms:vi(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Pt,blending:xn});s.uniforms.tEquirect.value=t;const a=new Ft(r,s),o=t.minFilter;return t.minFilter===Yn&&(t.minFilter=Et),new rh(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,r);e.setRenderTarget(s)}}function Qd(i){let e=new WeakMap,t=new WeakMap,n=null;function r(u,d=!1){return u==null?null:d?a(u):s(u)}function s(u){if(u&&u.isTexture){const d=u.mapping;if(d===Hr||d===kr)if(e.has(u)){const g=e.get(u).texture;return o(g,u.mapping)}else{const g=u.image;if(g&&g.height>0){const M=new Dl(g.height);return M.fromEquirectangularTexture(i,u),e.set(u,M),u.addEventListener("dispose",l),o(M.texture,u.mapping)}else return null}}return u}function a(u){if(u&&u.isTexture){const d=u.mapping,g=d===Hr||d===kr,M=d===$n||d===mi;if(g||M){let p=t.get(u);const h=p!==void 0?p.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==h)return n===null&&(n=new wo(i)),p=g?n.fromEquirectangular(u,p):n.fromCubemap(u,p),p.texture.pmremVersion=u.pmremVersion,t.set(u,p),p.texture;if(p!==void 0)return p.texture;{const x=u.image;return g&&x&&x.height>0||M&&x&&c(x)?(n===null&&(n=new wo(i)),p=g?n.fromEquirectangular(u):n.fromCubemap(u),p.texture.pmremVersion=u.pmremVersion,t.set(u,p),u.addEventListener("dispose",f),p.texture):null}}}return u}function o(u,d){return d===Hr?u.mapping=$n:d===kr&&(u.mapping=mi),u}function c(u){let d=0;const g=6;for(let M=0;M<g;M++)u[M]!==void 0&&d++;return d===g}function l(u){const d=u.target;d.removeEventListener("dispose",l);const g=e.get(d);g!==void 0&&(e.delete(d),g.dispose())}function f(u){const d=u.target;d.removeEventListener("dispose",f);const g=t.get(d);g!==void 0&&(t.delete(d),g.dispose())}function m(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:m}}function ep(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Ir("WebGLRenderer: "+n+" extension not supported."),r}}}function tp(i,e,t,n){const r={},s=new WeakMap;function a(m){const u=m.target;u.index!==null&&e.remove(u.index);for(const g in u.attributes)e.remove(u.attributes[g]);u.removeEventListener("dispose",a),delete r[u.id];const d=s.get(u);d&&(e.remove(d),s.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function o(m,u){return r[u.id]===!0||(u.addEventListener("dispose",a),r[u.id]=!0,t.memory.geometries++),u}function c(m){const u=m.attributes;for(const d in u)e.update(u[d],i.ARRAY_BUFFER)}function l(m){const u=[],d=m.index,g=m.attributes.position;let M=0;if(g===void 0)return;if(d!==null){const x=d.array;M=d.version;for(let y=0,E=x.length;y<E;y+=3){const w=x[y+0],A=x[y+1],C=x[y+2];u.push(w,A,A,C,C,w)}}else{const x=g.array;M=g.version;for(let y=0,E=x.length/3-1;y<E;y+=3){const w=y+0,A=y+1,C=y+2;u.push(w,A,A,C,C,w)}}const p=new(g.count>=65535?El:Sl)(u,1);p.version=M;const h=s.get(m);h&&e.remove(h),s.set(m,p)}function f(m){const u=s.get(m);if(u){const d=m.index;d!==null&&u.version<d.version&&l(m)}else l(m);return s.get(m)}return{get:o,update:c,getWireframeAttribute:f}}function np(i,e,t){let n;function r(u){n=u}let s,a;function o(u){s=u.type,a=u.bytesPerElement}function c(u,d){i.drawElements(n,d,s,u*a),t.update(d,n,1)}function l(u,d,g){g!==0&&(i.drawElementsInstanced(n,d,s,u*a,g),t.update(d,n,g))}function f(u,d,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,d,0,s,u,0,g);let p=0;for(let h=0;h<g;h++)p+=d[h];t.update(p,n,1)}function m(u,d,g,M){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let h=0;h<u.length;h++)l(u[h]/a,d[h],M[h]);else{p.multiDrawElementsInstancedWEBGL(n,d,0,s,u,0,M,0,g);let h=0;for(let x=0;x<g;x++)h+=d[x]*M[x];t.update(h,n,1)}}this.setMode=r,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=f,this.renderMultiDrawInstances=m}function ip(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:ke("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function rp(i,e,t){const n=new WeakMap,r=new st;function s(a,o,c){const l=a.morphTargetInfluences,f=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,m=f!==void 0?f.length:0;let u=n.get(o);if(u===void 0||u.count!==m){let T=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",T)};u!==void 0&&u.texture.dispose();const d=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,M=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],h=o.morphAttributes.normal||[],x=o.morphAttributes.color||[];let y=0;d===!0&&(y=1),g===!0&&(y=2),M===!0&&(y=3);let E=o.attributes.position.count*y,w=1;E>e.maxTextureSize&&(w=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const A=new Float32Array(E*w*4*m),C=new _l(A,E,w,m);C.type=Qt,C.needsUpdate=!0;const v=y*4;for(let W=0;W<m;W++){const R=p[W],O=h[W],V=x[W],H=E*w*4*W;for(let G=0;G<R.count;G++){const z=G*v;d===!0&&(r.fromBufferAttribute(R,G),A[H+z+0]=r.x,A[H+z+1]=r.y,A[H+z+2]=r.z,A[H+z+3]=0),g===!0&&(r.fromBufferAttribute(O,G),A[H+z+4]=r.x,A[H+z+5]=r.y,A[H+z+6]=r.z,A[H+z+7]=0),M===!0&&(r.fromBufferAttribute(V,G),A[H+z+8]=r.x,A[H+z+9]=r.y,A[H+z+10]=r.z,A[H+z+11]=V.itemSize===4?r.w:1)}}u={count:m,texture:C,size:new be(E,w)},n.set(o,u),o.addEventListener("dispose",T)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let d=0;for(let M=0;M<l.length;M++)d+=l[M];const g=o.morphTargetsRelative?1:1-d;c.getUniforms().setValue(i,"morphTargetBaseInfluence",g),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",u.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",u.size)}return{update:s}}function sp(i,e,t,n,r){let s=new WeakMap;function a(l){const f=r.render.frame,m=l.geometry,u=e.get(l,m);if(s.get(u)!==f&&(e.update(u),s.set(u,f)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),s.get(l)!==f&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,f))),l.isSkinnedMesh){const d=l.skeleton;s.get(d)!==f&&(d.update(),s.set(d,f))}return u}function o(){s=new WeakMap}function c(l){const f=l.target;f.removeEventListener("dispose",c),n.releaseStatesOfObject(f),t.remove(f.instanceMatrix),f.instanceColor!==null&&t.remove(f.instanceColor)}return{update:a,dispose:o}}const ap={[el]:"LINEAR_TONE_MAPPING",[tl]:"REINHARD_TONE_MAPPING",[nl]:"CINEON_TONE_MAPPING",[il]:"ACES_FILMIC_TONE_MAPPING",[sl]:"AGX_TONE_MAPPING",[al]:"NEUTRAL_TONE_MAPPING",[rl]:"CUSTOM_TONE_MAPPING"};function op(i,e,t,n,r){const s=new nn(e,t,{type:i,depthBuffer:n,stencilBuffer:r}),a=new nn(e,t,{type:Sn,depthBuffer:!1,stencilBuffer:!1}),o=new Gt;o.setAttribute("position",new mt([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new mt([0,2,0,0,2,0],2));const c=new Zu({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new Ft(o,c),f=new Pl(-1,1,1,-1,0,1);let m=null,u=null,d=!1,g,M=null,p=[],h=!1;this.setSize=function(x,y){s.setSize(x,y),a.setSize(x,y);for(let E=0;E<p.length;E++){const w=p[E];w.setSize&&w.setSize(x,y)}},this.setEffects=function(x){p=x,h=p.length>0&&p[0].isRenderPass===!0;const y=s.width,E=s.height;for(let w=0;w<p.length;w++){const A=p[w];A.setSize&&A.setSize(y,E)}},this.begin=function(x,y){if(d||x.toneMapping===tn&&p.length===0)return!1;if(M=y,y!==null){const E=y.width,w=y.height;(s.width!==E||s.height!==w)&&this.setSize(E,w)}return h===!1&&x.setRenderTarget(s),g=x.toneMapping,x.toneMapping=tn,!0},this.hasRenderPass=function(){return h},this.end=function(x,y){x.toneMapping=g,d=!0;let E=s,w=a;for(let A=0;A<p.length;A++){const C=p[A];if(C.enabled!==!1&&(C.render(x,w,E,y),C.needsSwap!==!1)){const v=E;E=w,w=v}}if(m!==x.outputColorSpace||u!==x.toneMapping){m=x.outputColorSpace,u=x.toneMapping,c.defines={},Ge.getTransfer(m)===Ke&&(c.defines.SRGB_TRANSFER="");const A=ap[u];A&&(c.defines[A]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=E.texture,x.setRenderTarget(M),x.render(l,f),M=null,d=!1},this.isCompositing=function(){return d},this.dispose=function(){s.dispose(),a.dispose(),o.dispose(),c.dispose()}}const Il=new wt,ga=new ki(1,1),Ul=new _l,Nl=new fu,Fl=new yl,Lo=[],Do=[],Io=new Float32Array(16),Uo=new Float32Array(9),No=new Float32Array(4);function yi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Lo[r];if(s===void 0&&(s=new Float32Array(r),Lo[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function ut(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function ht(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function zr(i,e){let t=Do[e];t===void 0&&(t=new Int32Array(e),Do[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function lp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function cp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ut(t,e))return;i.uniform2fv(this.addr,e),ht(t,e)}}function up(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ut(t,e))return;i.uniform3fv(this.addr,e),ht(t,e)}}function hp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ut(t,e))return;i.uniform4fv(this.addr,e),ht(t,e)}}function fp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ut(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),ht(t,e)}else{if(ut(t,n))return;No.set(n),i.uniformMatrix2fv(this.addr,!1,No),ht(t,n)}}function dp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ut(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),ht(t,e)}else{if(ut(t,n))return;Uo.set(n),i.uniformMatrix3fv(this.addr,!1,Uo),ht(t,n)}}function pp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ut(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),ht(t,e)}else{if(ut(t,n))return;Io.set(n),i.uniformMatrix4fv(this.addr,!1,Io),ht(t,n)}}function mp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function gp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ut(t,e))return;i.uniform2iv(this.addr,e),ht(t,e)}}function _p(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ut(t,e))return;i.uniform3iv(this.addr,e),ht(t,e)}}function vp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ut(t,e))return;i.uniform4iv(this.addr,e),ht(t,e)}}function xp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Mp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ut(t,e))return;i.uniform2uiv(this.addr,e),ht(t,e)}}function Sp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ut(t,e))return;i.uniform3uiv(this.addr,e),ht(t,e)}}function Ep(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ut(t,e))return;i.uniform4uiv(this.addr,e),ht(t,e)}}function yp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(ga.compareFunction=t.isReversedDepthBuffer()?wa:Aa,s=ga):s=Il,t.setTexture2D(e||s,r)}function Tp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Nl,r)}function bp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Fl,r)}function Ap(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Ul,r)}function wp(i){switch(i){case 5126:return lp;case 35664:return cp;case 35665:return up;case 35666:return hp;case 35674:return fp;case 35675:return dp;case 35676:return pp;case 5124:case 35670:return mp;case 35667:case 35671:return gp;case 35668:case 35672:return _p;case 35669:case 35673:return vp;case 5125:return xp;case 36294:return Mp;case 36295:return Sp;case 36296:return Ep;case 35678:case 36198:case 36298:case 36306:case 35682:return yp;case 35679:case 36299:case 36307:return Tp;case 35680:case 36300:case 36308:case 36293:return bp;case 36289:case 36303:case 36311:case 36292:return Ap}}function Rp(i,e){i.uniform1fv(this.addr,e)}function Cp(i,e){const t=yi(e,this.size,2);i.uniform2fv(this.addr,t)}function Pp(i,e){const t=yi(e,this.size,3);i.uniform3fv(this.addr,t)}function Lp(i,e){const t=yi(e,this.size,4);i.uniform4fv(this.addr,t)}function Dp(i,e){const t=yi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Ip(i,e){const t=yi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Up(i,e){const t=yi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Np(i,e){i.uniform1iv(this.addr,e)}function Fp(i,e){i.uniform2iv(this.addr,e)}function Op(i,e){i.uniform3iv(this.addr,e)}function Bp(i,e){i.uniform4iv(this.addr,e)}function zp(i,e){i.uniform1uiv(this.addr,e)}function Vp(i,e){i.uniform2uiv(this.addr,e)}function Gp(i,e){i.uniform3uiv(this.addr,e)}function Hp(i,e){i.uniform4uiv(this.addr,e)}function kp(i,e,t){const n=this.cache,r=e.length,s=zr(t,r);ut(n,s)||(i.uniform1iv(this.addr,s),ht(n,s));let a;this.type===i.SAMPLER_2D_SHADOW?a=ga:a=Il;for(let o=0;o!==r;++o)t.setTexture2D(e[o]||a,s[o])}function Wp(i,e,t){const n=this.cache,r=e.length,s=zr(t,r);ut(n,s)||(i.uniform1iv(this.addr,s),ht(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Nl,s[a])}function Xp(i,e,t){const n=this.cache,r=e.length,s=zr(t,r);ut(n,s)||(i.uniform1iv(this.addr,s),ht(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Fl,s[a])}function qp(i,e,t){const n=this.cache,r=e.length,s=zr(t,r);ut(n,s)||(i.uniform1iv(this.addr,s),ht(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||Ul,s[a])}function Yp(i){switch(i){case 5126:return Rp;case 35664:return Cp;case 35665:return Pp;case 35666:return Lp;case 35674:return Dp;case 35675:return Ip;case 35676:return Up;case 5124:case 35670:return Np;case 35667:case 35671:return Fp;case 35668:case 35672:return Op;case 35669:case 35673:return Bp;case 5125:return zp;case 36294:return Vp;case 36295:return Gp;case 36296:return Hp;case 35678:case 36198:case 36298:case 36306:case 35682:return kp;case 35679:case 36299:case 36307:return Wp;case 35680:case 36300:case 36308:case 36293:return Xp;case 36289:case 36303:case 36311:case 36292:return qp}}class Kp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=wp(t.type)}}class $p{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Yp(t.type)}}class Zp{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const ys=/(\w+)(\])?(\[|\.)?/g;function Fo(i,e){i.seq.push(e),i.map[e.id]=e}function Jp(i,e,t){const n=i.name,r=n.length;for(ys.lastIndex=0;;){const s=ys.exec(n),a=ys.lastIndex;let o=s[1];const c=s[2]==="]",l=s[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===r){Fo(t,l===void 0?new Kp(o,i,e):new $p(o,i,e));break}else{let m=t.map[o];m===void 0&&(m=new Zp(o),Fo(t,m)),t=m}}}class Rr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);Jp(o,c,this)}const r=[],s=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(a):s.push(a);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function Oo(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const jp=37297;let Qp=0;function em(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Bo=new Ie;function tm(i){Ge._getMatrix(Bo,Ge.workingColorSpace,i);const e=`mat3( ${Bo.elements.map(t=>t.toFixed(4))} )`;switch(Ge.getTransfer(i)){case Lr:return[e,"LinearTransferOETF"];case Ke:return[e,"sRGBTransferOETF"];default:return Ce("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function zo(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=(i.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`
...
`)}const im={[el]:"Linear",[tl]:"Reinhard",[nl]:"Cineon",[il]:"ACESFilmic",[sl]:"AgX",[al]:"Neutral",[rl]:"Custom"};function rm(i,e){const t=im[e];return t===void 0?(Ce("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Mr=new D;function sm(){Ge.getLuminanceCoefficients(Mr);const i=Mr.x.toFixed(4),e=Mr.y.toFixed(4),t=Mr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const pm={[yr]:"SHADOWMAP_TYPE_PCF",[Di]:"SHADOWMAP_TYPE_VSM"};function mm(i){return pm[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const gm={[$n]:"ENVMAP_TYPE_CUBE",[mi]:"ENVMAP_TYPE_CUBE",[Nr]:"ENVMAP_TYPE_CUBE_UV"};function _m(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":gm[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const vm={[mi]:"ENVMAP_MODE_REFRACTION"};function xm(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":vm[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Mm={[Qo]:"ENVMAP_BLENDING_MULTIPLY",[Xc]:"ENVMAP_BLENDING_MIX",[qc]:"ENVMAP_BLENDING_ADD"};function Sm(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Mm[i.combine]||"ENVMAP_BLENDING_NONE"}function Em(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function ym(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=mm(t),l=_m(t),f=xm(t),m=Sm(t),u=Em(t),d=am(t),g=om(s),M=r.createProgram();let p,h,x=t.glslVersion?"#version "+t.glslVersion+`
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
				...
				`,n.style.borderColor=l?"#FF2EAD":"#2DE2E6",n.style.boxShadow=l?"0 0 30px rgba(255,46,173,0.8)":"0 0 20px rgba(45,226,230,0.5)"),r&&(r.style.transform=`
					...
					translate(-50%, -50%)
					scale(${l?0:1})
				`,r.style.opacity=l?"0":"1"),l&&!f&&Bl(),f=l,requestAnimationFrame(h)};return window.addEventListener("mousemove",M,{passive:!0}),document.addEventListener("mouseleave",p),h(),()=>{window.removeEventListener("mousemove",M),document.removeEventListener("mouseleave",p)}});var u=ug(),d=bt(u);Ni(d,M=>n=M,()=>n);var g=At(d,2);Ni(g,M=>r=M,()=>r),_t(u),Ni(u,M=>t=M,()=>t),zt(i,u),Mi()}var fg=Vt('<!> <!> <div class="min-h-screen bg-void"><!> <!></div>',1);function xg(i,e){xi(e,!0),oc();let t=Bi("hero");const n=["hero","about","skills","experience","projects","contact"];function r(){const u=window.innerHeight*.45;let d="hero";for(const g of n){const M=document.getElementById(g);M&&M.getBoundingClientRect().top<u&&(d=g)}_n(t,d,!0)}function s(u){u.target.closest('a, button, [role="button"]')&&Bl()}Wi(()=>(window.addEventListener("scroll",r,{passive:!0}),window.addEventListener("mouseover",s,{passive:!0}),()=>{window.removeEventListener("scroll",r),window.removeEventListener("mouseover",s)}));var a=fg(),o=Ur(a);hg(o,{});var c=At(o,2);yc(c,{get activeSection(){return Tt(t)}});var l=At(c,2),f=bt(l);lc(f,()=>e.children);var m=At(f,2);lg(m,{}),_t(l),zt(i,a),Mi()}export{xg as component,vg as universal};
